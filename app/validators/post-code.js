...
const PostCode = BaseValidator.extend({
  /**
    Executes when the value of a property, having "PostCode" validator changes.
    Checks if the value contains only letters, digits, spaces and dashes.
  ...
  */
  validate(value, options) {
    if (value) {
      ...
      */
      const regex = /^([A-Za-z\d]+( |-)?[A-Za-z\d]+$)|^[A-Za-z]*$/;
